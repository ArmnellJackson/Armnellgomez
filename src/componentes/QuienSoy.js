			...
			<main>
					<div className='quien-soy-container'>
						<p className='quien-soy-text'>
							...
							<br /><br />
							Mi enfoque siempre ha sido aprender y crecer constantemente, cada desafío que tomo lo llevo con constancia y paso a paso, como ya dije, seguiré desarrollando mis habilidades estudiando y practicando con la construcción de proyectos web propios y de terceros.
							<br /><br />
